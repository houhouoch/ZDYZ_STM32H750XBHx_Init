...
void StartLedTask(void *argument) {
    ...
    for(;;) {
        ...
        CANFD_Send_Standard(0x123, myData);
        CANFD_Send_Extended(0x12345678,myData);
        CANFD_Send_ExtRemote(0x789456);
    }
}
...
void GUI_Task(void *argument)
{
  /* USER CODE BEGIN GUI_Task */    
    ...
    //加载显示树
    UI_Tree_Init();
    lv_obj_remove_event_cb(ui.HOME_PAGE_cont_1, btnTree_event_handler);
    lv_obj_add_event_cb(ui.HOME_PAGE_cont_1, btnTree_event_handler, LV_EVENT_ALL, NULL);    
