...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen, 800, 268);
    ...
    lv_obj_set_size(ui->screen_cont_1, 800, 280);
    ...
    lv_img_set_src(ui->screen_img_1, &_Logo_alpha_569x159);
    lv_img_set_pivot(ui->screen_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_1, 0);
    lv_obj_set_pos(ui->screen_img_1, 114, 58);
    lv_obj_set_size(ui->screen_img_1, 569, 159);
