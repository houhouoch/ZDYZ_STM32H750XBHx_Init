# 🚀 GT1158/GT1151 多点触摸测试说明 

本更新增加了对 **5 点触摸** 的底层支持。虽然在标准的 GUI 交互（如 LVGL）中通常只处理单点信号，但底层驱动的升级能够更准确地反馈硬件性能，并为后续的功能提供基础。
...
如果发现触摸位置与屏幕显示相反，请根据以下逻辑修正：
* **水平翻转**：`x_new = 800 - x_raw`
* **垂直翻转**：`y_new = 480 - y_raw`
