...
enum
{
    ...
    //ENTER确认
    LV_KEY_ENTER = 100 + 1,
    LV_KEY_ENTER_LONGP,     /* Enter LongPress */
    //编码器按键
    LV_KEY_ENCODER,
    LV_KEY_ENCODER_LONGP,
    ...
    //ESC退出
    LV_KEY_ESC,
    LV_KEY_ESC_LONGP,       /* ESC LongPress */
    LV_KEY_RETURN,          /*  global lock */
    //左右按键
    LV_KEY_LEFT,
    LV_KEY_LEFT_LONGP,
    LV_KEY_RIGHT,
