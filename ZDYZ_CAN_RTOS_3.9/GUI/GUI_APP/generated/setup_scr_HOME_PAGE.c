...
void setup_scr_HOME_PAGE(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->HOME_PAGE_back_edit_i_set_pos, 46, 159);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_edit_IUnit_neg, 180, 162);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_edit_Iset_neg, 45, 162);
    lv_obj_set_size(ui->HOME_PAGE_edit_Iset_neg, 140, 35);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_label_Set_I_POS, 0, 115);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_back_edit_i_set_neg, 46, 110);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_edit_IUnit_pos, 180, 112);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_edit_Iset_pos, 45, 110);
    lv_obj_set_size(ui->HOME_PAGE_edit_Iset_pos, 140, 33);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_label_set_i, 84, 75);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_back_edit_v_set, 42, 35);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_edit_VUnit, 179, 37);
    lv_obj_set_size(ui->HOME_PAGE_edit_VUnit, 25, 33);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_label_Set_V, 84, 0);
    lv_obj_set_size(ui->HOME_PAGE_label_Set_V, 81, 35);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_edit_Vset, 48, 34);
    lv_obj_set_size(ui->HOME_PAGE_edit_Vset, 133, 33);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_label_Iout, 16, 103);
    lv_obj_set_size(ui->HOME_PAGE_label_Iout, 488, 134);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_img_Menu, 27, 185);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_label_CC, 19, 72);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_label_CV, 29, 71);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_label_2, 10, 134);
    lv_obj_set_size(ui->HOME_PAGE_label_2, 84, 38);
    ...
    lv_obj_set_style_text_align(ui->HOME_PAGE_label_2, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->HOME_PAGE_label_1, 0, 135);
    ...
    lv_obj_set_style_border_side(ui->HOME_PAGE_label_1, LV_BORDER_SIDE_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
